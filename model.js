...
// y ansqer para guardar el texto de la pregunta y el de la respuesta
let quizzes = [
  {
...
//
/**
 *Elimina el quiz situado en la posición a borrar.
 *
...
exports.deleteByIndex = id => {
  ...
  const quiz = quizzes[id];
  if (typeof quiz == 'undefined') {
    throw new Error('El valor del parámetro no es valido');
  }
  quizzes.splice(id, 1);
  save(); 
 };
